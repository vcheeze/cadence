...
<div class="container flex gap-8 py-6 max-sm:flex-col md:py-8">
	<SideNav />
	<div>
		...
		<p class="leading-7 not-first:mt-6">To use Cadence, you must:</p>
		...
		<p class="leading-7 not-first:mt-6">You agree to use Cadence only for:</p>
		<ul class="my-6 ml-6 list-disc [&>li]:mt-2">
		...
		<p class="leading-7 not-first:mt-6">You must not:</p>
		<ul class="my-6 ml-6 list-disc [&>li]:mt-2">
		...
		<p class="leading-7 not-first:mt-6">
			Cadence is provided "as is" without warranties of any kind. We are not liable for any damages
